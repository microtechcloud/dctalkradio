...
// app.set("views",path.join(__dirname,`..${path.sep}front-end`));
app.set("views",path.join(__dirname,`..${path.sep}client`));

//set static folder
app.use(express.static(path.join(__dirname,`..${path.sep}client`)))
//log http requests
